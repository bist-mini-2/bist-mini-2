...
## 📅 3. 3인 기준 2주 단기 집중 개발 일정 및 R&R 계획 (6/16 ~ 6/30)

본 계획은 **6월 30일 프로젝트 완료 및 최종 배포**를 목표로, 평일 작업(총 11영업일) 기준으로 3명의 팀원(A, B, C)에게 태스크를 유기적으로 분담한 단기 집중 로드맵입니다.

### 👥 3.1 팀원 구성 및 R&R (Role & Responsibility)
