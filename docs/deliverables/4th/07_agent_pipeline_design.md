...
본 문서는 `bist-mini-2` 플랫폼의 3대 핵심 기능인 **일반 채팅 허브**, **대규모 문헌 분석기**, **맞춤형 젬 팩토리** 각각에 대하여 개별적으로 동작하는 **파이프라인 아키텍처 흐름(Pipeline Architecture Flow)**을 단계별(Step-by-Step)로 기술한 랩업 리포트(Completion Report)입니다. 구글 독스(Google Docs) 본문 서식에 완벽히 연동되도록 작성되었습니다.
...
> *   **업로드 대상 파일**: `docs/deliverables/4th/ai_agent_workflow.png`
