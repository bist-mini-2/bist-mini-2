...
| :---: | :--- | :--- | :--- |
| **01** | **비즈니스 모델 및 린 캔버스** | [01_lean_canvas_and_business_plan.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/01_lean_canvas_and_business_plan.md) | • UVP, 3대 고객군, 9대 린 캔버스 블록 명세<br>• 월간 유저 1,000명 기준 API 원가 계산서($1.05/명) 및 B2C/B2B 수익모델 |
| **02** | **타겟 사용자 페르소나 및 유스케이스** | [02_personas_and_use_cases.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/02_personas_and_use_cases.md) | • 박지수(석사), 김민우(바이오 책임), 박영지(포닥) 세밀 페르소나 정의<br>• 4대 핵심 기능의 예외 케이스 처리 유스케이스 모델 |
| **03** | **최종 기능 상세 명세서** | [03_final_functional_specifications.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/03_final_functional_specifications.md) | • 3대 도메인 RAG 규모 및 화면 4종별 API 입출력/DB 연동 테이블 기능 상세 대조표 |
| **04** | **시스템 아키텍처 및 API 명세서** | [04_system_architecture_and_api_spec.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/04_system_architecture_and_api_spec.md) | • 3-Tier 아키텍처 구성도 및 API 전체 REST DTO 정의서<br>• PostgreSQL/pgvector HNSW 인덱싱 스키마 설계 |
| **05** | **QA 테스트 및 정량적 성능 평가서** | [05_qa_test_and_quantitative_evaluation_report.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/05_qa_test_and_quantitative_evaluation_report.md) | • **병렬 RAG 동시 타격(Implemented) 레이턴시 2.1초 단축(23% 절감)** 데이터 증명<br>• HNSW Cos 유사도 0.35 필터 정밀도, 번역 원어 팩트 보존성, 보안 파쇄 50회차 검증 |
| **06** | **ArXiv 데이터셋 EDA 및 DB 설계서** | [06_database_schema_and_dataset_eda.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/06_database_schema_and_dataset_eda.md) | • 106,974건의 도메인 파싱 데이터셋 EDA 통계<br>• PostgreSQL 17 및 pgvector 물리 DDL 스크립트 |
| **07** | **시스템 종합 시퀀스 다이어그램** | [07_system_sequence_diagrams.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/07_system_sequence_diagrams.md) | • 배치 임베딩 적재, 병렬 RAG 일반 챗 SSE 스트리밍, 샌드박스 파쇄, 비동기 배치 공백 분석 시간 축 시퀀스 모델 |
| **08** | **개발 로드맵 및 WBS 실적 보고서** | [08_development_roadmap_and_wbs.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/08_development_roadmap_and_wbs.md) | • 1~3단계 R&R 최종 매트릭스 및 일자별 마일스톤 최종 검증 성공 지표 |
| **09** | **산출물 리스트 및 개발 완료 보고서** | [09_project_deliverables_and_wrapup.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/09_project_deliverables_and_wrapup.md) | • 4차 산출물 종합 인덱스 체크시트 및 코드베이스 구성 보고서 |
| **10** | **기술적 문제 해결 및 트러블슈팅 일지** | [10_troubleshooting_and_lessons_learned.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/10_troubleshooting_and_lessons_learned.md) | • Pytest OpenAI 키 미인식 에러 리팩토링, pgvector 10만 건 적재 커넥션 락업 해결, 번역 시 인용구 강제 덮어쓰기 복원 기법 |
| **11** | **로컬 가동 가이드 및 API cURL 테스트 핸드북** | [11_quickstart_and_curl_handbook.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/11_quickstart_and_curl_handbook.md) | • FastAPI/Next.js 로컬 구동 커맨드, 멱등 데이터 적재 배치 기동, 회원가입/인증/병렬챗/배치분석 cURL 예시집 |
| **12** | **프로젝트 종합 기술 스택 명세서** | [12_technology_stack_summary.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/12_technology_stack_summary.md) | • 프론트엔드, 백엔드, 데이터베이스/캐시, AI/에이전트 의존성 패키지 및 런타임 상세 명세표 |
...
*   **데이터베이스 DDL 스크립트** (DDL): [06_database_schema_and_dataset_eda.md](file:///Users/pileuszu/Repos/bist-mini-2/docs/deliverables/4th/06_database_schema_and_dataset_eda.md#💾-3-postgresql-17--pgvector-물리-ddl-스크립트-schemasql)
...
*   **일반 챗 허브 에이전트 & 컨트롤러**:
    *   [supervisor.py](file:///Users/pileuszu/Repos/bist-mini-2/backend/api/v1/chat/multi_agent/supervisor.py) & [services.py](file:///Users/pileuszu/Repos/bist-mini-2/backend/api/v1/chat/services.py)
...
*   **보안 피어 리뷰 및 가설 디펜스 아레나 API 테스트 - [향후 검증 로드맵 (인터페이스 모크)]**:
    *   [test_defense_arena.py](file:///Users/pileuszu/Repos/bist-mini-2/backend/tests/test_defense_arena.py)
