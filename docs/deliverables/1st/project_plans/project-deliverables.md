...
*   **상세 기능 명세서**: [functional-specification.md](file:///c:/Repo/bist-mini-2/docs/deliverables/1st/project_plans/functional-specification.md)
...
*   **테스트 검증 완료 보고서** (`c:/Repo/bist-mini-2/docs/deliverables/1st/project_plans/test-report.md`):
    *   *역할*: API 및 도구 연동 단위 테스트 성공 기록 및 RAG 정확도 팩트체크 테스트 스코어.
*   **제품 시연 가이드 & 완료 보고서** (`c:/Repo/bist-mini-2/docs/deliverables/1st/project_plans/walkthrough.md` 업데이트):
